...
const stackdriver_cloudtrace_utils_1 = require("../src/stackdriver-cloudtrace-utils");
describe('Stackdriver CloudTrace Exporter Utils', () => {
    describe('createLinks()', () => {
        ...
        it('should return stackdriver links', () => {
            const stackdriverLinks = stackdriver_cloudtrace_utils_1.createLinks(links, 2);
    ...
    describe('createTimeEvents()', () => {
        ...
        it('should return stackdriver TimeEvents', () => {
            const stackdriverTimeEvents = stackdriver_cloudtrace_utils_1.createTimeEvents(annotations, messageEvents, 2, 3);
            ...
            assert.deepStrictEqual(stackdriverTimeEvents.timeEvent, expectedTimeEvent);
        });
        it('should return stackdriver TimeEvents when empty annotations and messageEvents', () => {
            const stackdriverTimeEvents = stackdriver_cloudtrace_utils_1.createTimeEvents([], [], 0, 0);
    ...
    describe('createAttributes()', () => {
        ...
        it('should return stackdriver Attributes', () => {
            const stackdriverAttribute = stackdriver_cloudtrace_utils_1.createAttributes(attributes, {}, 0);
            assert.strictEqual(stackdriverAttribute.droppedAttributesCount, 0);
            assert.strictEqual(Object.keys(stackdriverAttribute.attributeMap).length, 3);
            assert.deepStrictEqual(stackdriverAttribute.attributeMap, expectedAttributeMap);
        });
        it('should return stackdriver Attributes with labels', () => {
            const stackdriverAttribute = stackdriver_cloudtrace_utils_1.createAttributes(attributes, {
            ...
            assert.strictEqual(Object.keys(stackdriverAttribute.attributeMap).length, 5);
            assert.deepStrictEqual(stackdriverAttribute.attributeMap, expectedAttributeMap);
        });
        it('should map http attributes to the stackdriver format', () => {
            ...
            const stackdriverAttribute = stackdriver_cloudtrace_utils_1.createAttributes(attributes, {}, 0);
            assert.strictEqual(stackdriverAttribute.droppedAttributesCount, 0);
            assert.strictEqual(Object.keys(stackdriverAttribute.attributeMap).length, 8);
            assert.deepStrictEqual(stackdriverAttribute.attributeMap, expectedMap);
        });
    });
    describe('getResourceLabels()', () => {
        it('should return K8s container labels', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = {
                type: 'k8s_container',
                labels: {
                    container_name: 'c1',
            ...
            const resourceLabels = yield stackdriver_cloudtrace_utils_1.getResourceLabels(resolvingPromise);
            assert.strictEqual(Object.keys(resourceLabels).length, 5);
            assert.deepStrictEqual(resourceLabels, expectedLabels);
        }));
        it('should return gce instance labels', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = {
                type: 'gce_instance',
                labels: {
        ...
        it('should return aws ec2 instance labels', () => __awaiter(void 0, void 0, void 0, function* () {
            const resource = {
...
//# sourceMappingURL=test-stackdriver-cloudtrace-utils.js.map